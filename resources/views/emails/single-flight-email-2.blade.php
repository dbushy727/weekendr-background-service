                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td valign="top" class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #111111;font-family: Georgia;font-size: 16px;line-height: 150%;text-align: left;">
                                                                                        <h3 style="text-align: center;">You could be in {{ $flight_deal->destination_city }} {{ $flight_deal->isThisWeekend() ? 'this' : 'next '}} weekend.</h3>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            <div style="text-align: center;"><span style="font-size:14px">To see more flight details or to&nbsp;book&nbsp;a flight, click on the "Book Flight" button above.</span></div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
